...
from .views import CadastroPsicologoView, LoginUsuarioView, LogoutUsuarioView, PsicologoListView, CadastroPacienteView, PacienteListView, inativar_paciente, ativar_paciente, PacienteUpdateView
